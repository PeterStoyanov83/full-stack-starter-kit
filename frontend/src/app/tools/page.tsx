      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 md:mb-8 flex flex-col md:flex-row justify-between items-start md:items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm sm:text-base text-gray-600">Открийте и споделете полезни AI инструменти</p>
          </div>
          <button
        ...
        {/* Filters */}
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-4 sm:p-6 mb-6 sm:mb-8">
        ...
        {tools.length > 0 && (
          <div className="flex justify-between items-center mb-6">
            <div className="text-sm text-gray-600">
              Намерени {tools.length} инструмента
            </div>
        ...
        {loading && tools.length === 0 ? (
          ...
          <>
            ...
            {viewMode === 'grid' && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {tools.map((tool) => (
                  <div
                    key={tool.id}
                    className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 p-4 sm:p-6 hover:shadow-2xl transition-all duration-300 hover:scale-105"
                  >
                    {/* Tool Header */}
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center pt-3 sm:pt-4 border-t border-gray-200 space-y-2 sm:space-y-0">
                      ...
                      <div className="flex space-x-2">
                        <a
                          ...
                          className="flex items-center justify-center bg-blue-600 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium hover:bg-blue-700 transition-colors touch-manipulation flex-1 sm:flex-initial"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center justify-center bg-gray-100 text-gray-700 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium hover:bg-gray-200 transition-colors touch-manipulation flex-1 sm:flex-initial"
                        >
                          <Eye className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
                          <span className="hidden sm:inline">Детайли</span>
                          <span className="sm:hidden sr-only">Детайли</span>
                        </button>
                      </div>
                    </div>
                  </div>
            ...
            {/* List View - Compact */}
            {viewMode === 'list' && (
              <div className="bg-white/80 backdrop-blur-md rounded-lg shadow-md border border-white/20 overflow-hidden">
